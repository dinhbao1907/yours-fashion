...
async function loadStats(filter = 'month') {
  try {
    ...
    const res = await fetch(`https://yoursfashion.id.vn/api/admin/stats?filter=${filter}`, {
...
async function loadRecentOrders(filter = 'month') {
  try {
    const res = await fetch(`https://yoursfashion.id.vn/api/admin/orders?limit=5&filter=${filter}`, {
      headers: getAuthHeaders()
    });
...
async function loadDesigns() {
  try {
    const res = await fetch('https://yoursfashion.id.vn/api/admin/designs', {
      headers: getAuthHeaders()
    });
...
async function loadBestSellers(filter = 'month') {
  const res = await fetch(`https://yoursfashion.id.vn/api/admin/best-sellers?filter=${filter}`);
...
async function loadAnalytics(filter = 'month') {
  const res = await fetch(`https://yoursfashion.id.vn/api/admin/analytics?filter=${filter}`);
...
async function loadOrderStats(filter = 'month') {
  ...
  const res = await fetch(`https://yoursfashion.id.vn/api/admin/order-stats?filter=${filter}`);
  const stats = await res.json();
...
window.approveOrder = async function(id) {
  await fetch(`https://yoursfashion.id.vn/api/admin/orders/${id}/approve`, { method: 'POST' });
  loadRecentOrders();
};
window.rejectOrder = async function(id) {
  await fetch(`https://yoursfashion.id.vn/api/admin/orders/${id}/reject`, { method: 'POST' });
  loadRecentOrders();
};
window.approveDesign = async function(id) {
  try {
    const response = await fetch(`https://yoursfashion.id.vn/api/admin/designs/${id}/approve`, { 
      method: 'POST',
      headers: getAuthHeaders()
    });
...
window.completeOrder = async function(id) {
  await fetch(`https://yoursfashion.id.vn/api/admin/orders/${id}/complete`, { method: 'POST' });
  loadAllOrders();
};
window.deliverOrder = async function(id) {
  await fetch(`https://yoursfashion.id.vn/api/admin/orders/${id}/deliver`, { method: 'POST' });
};
window.finishOrder = async function(id) {
  await fetch(`https://yoursfashion.id.vn/api/admin/orders/${id}/finish`, { method: 'POST' });
};
...
async function debugDesigns() {
  try {
    const response = await fetch('https://yoursfashion.id.vn/api/admin/designs', {
      headers: getAuthHeaders()
    });
...
window.addEventListener('DOMContentLoaded', () => {
  document.getElementById('editDesignForm').onsubmit = async function(e) {
    ...
    await fetch(`https://yoursfashion.id.vn/api/admin/designs/${id}`, {
      method: 'PUT',
...
window.addEventListener('DOMContentLoaded', () => {
  document.getElementById('rejectReasonForm').onsubmit = async function(e) {
    ...
    try {
      const response = await fetch(`https://yoursfashion.id.vn/api/admin/designs/${id}/reject`, {
        method: 'POST',
        headers: getAuthHeaders(),
...
async function loadDesigners() {
  try {
    const res = await fetch('https://yoursfashion.id.vn/api/admin/designers');
...
async function unbanDesigner(designerId) {
  ...
  try {
    const res = await fetch(`https://yoursfashion.id.vn/api/admin/designers/${designerId}/unban`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
async function viewDesignerDetails(designerId) {
  try {
    const res = await fetch(`https://yoursfashion.id.vn/api/admin/designers/${designerId}`);
    const data = await res.json();
...
async function loadCustomers() {
  try {
    const res = await fetch('https://yoursfashion.id.vn/api/admin/customers');
...
async function unbanCustomer(customerId) {
  ...
  try {
    const res = await fetch(`https://yoursfashion.id.vn/api/admin/customers/${customerId}/unban`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ adminUsername: 'Admin' })
    });
...
async function viewCustomerDetails(customerId) {
  try {
    const res = await fetch(`https://yoursfashion.id.vn/api/admin/customers/${customerId}`);
    const data = await res.json();
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  banForm.onsubmit = async function(e) {
    ...
    try {
      const res = await fetch(`https://yoursfashion.id.vn/api/admin/designers/${designerId}/ban`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ 
          reason, 
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  banCustomerForm.onsubmit = async function(e) {
    ...
    try {
      const res = await fetch(`https://yoursfashion.id.vn/api/admin/customers/${customerId}/ban`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ 
          reason, 
...
async function loadNotifications() {
  const res = await fetch('https://yoursfashion.id.vn/api/admin/notifications?limit=100');
...
window.markNotificationRead = async function(id) {
  await fetch(`https://yoursfashion.id.vn/api/admin/notifications/${id}/read`, { method: 'POST' });
  loadNotifications();
};

window.deleteNotification = async function(id) {
  if (!confirm('Bạn có chắc chắn muốn xóa thông báo này?')) return;
  await fetch(`https://yoursfashion.id.vn/api/admin/notifications/${id}`, { method: 'DELETE' });
  loadNotifications();
};

document.getElementById('markAllReadBtn').onclick = async function() {
  await fetch('https://yoursfashion.id.vn/api/admin/notifications/read-all', { method: 'POST' });
  loadNotifications();
};
document.getElementById('clearAllBtn').onclick = async function() {
  if (!confirm('Bạn có chắc chắn muốn xóa tất cả thông báo?')) return;
  await fetch('https://yoursfashion.id.vn/api/admin/notifications', { method: 'DELETE' });
  loadNotifications();
};
...
async function loadAllOrders() {
  try {
    const res = await fetch('https://yoursfashion.id.vn/api/admin/orders', {
      headers: getAuthHeaders()
    });
...
async function updateCustomDesignStatus(orderId) {
  try {
    ...
    const res = await fetch(`https://yoursfashion.id.vn/api/admin/orders/${orderId}/design-status`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        ...getAuthHeaders()
...
async function updateOrderStatus(orderId, status) {
  ...
  if (endpoint) {
    await fetch(`https://yoursfashion.id.vn${endpoint}`, { method: 'POST' });
  }
}
...
async function loadDesignerPayouts() {
  try {
    const response = await fetch('https://yoursfashion.id.vn/api/admin/designer-payouts', {
      headers: getAuthHeaders()
    });
...
async function payDesigner(designerUsername) {
  ...
  try {
    const res = await fetch(`https://yoursfashion.id.vn/api/admin/designer-payouts/${designerUsername}/pay`, {
      method: 'POST',
      headers: getAuthHeaders()
    });
...
async function loadWithdrawals() {
  ...
  try {
    const response = await fetch('https://yoursfashion.id.vn/api/admin/withdrawals', {
      headers: getAuthHeaders()
    });
...
function setupProcessWithdrawalModal() {
  ...
  form.onsubmit = async (e) => {
    ...
    try {
      const response = await fetch(`https://yoursfashion.id.vn/api/admin/withdrawals/${transactionId}/process`, {
        method: 'POST',
        headers: {
          ...getAuthHeaders(),
          'Content-Type': 'application/json'
...
async function processWithdrawal(transactionId) {
  try {
    ...
    const response = await fetch(`https://yoursfashion.id.vn/api/admin/withdrawals?transactionId=${transactionId}`, {
      headers: getAuthHeaders()
    });
