      ...
      if (design) {
        ...
        document.getElementById('likeHeart').addEventListener('click', async () => {
          ...
          if (liked) {
            ...
            await fetch(`https://yours-fashion.vercel.app/api/designs/${design.designId}/like`, { method: 'POST', headers: { 'Content-Type': 'application/json' } });
            ...
            await fetch(`https://yours-fashion.vercel.app/api/designs/${design.designId}/unlike`, { method: 'POST', headers: { 'Content-Type': 'application/json' } });
