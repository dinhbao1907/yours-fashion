...
window.onload = async () => {
  try {
    const response = await fetch("https://yours-fashion.onrender.com/api/user", {
      headers: {
...
async function updateProfile(data) {
  try {
    const response = await fetch("https://yours-fashion.onrender.com/api/update-profile", {
      method: "PUT",
      headers: {
...
async function loadOrderHistory() {
  ...
  try {
    const res = await fetch('https://yours-fashion.onrender.com/api/my-orders', {
...
if (changeCredentialsForm) {
  changeCredentialsForm.addEventListener('submit', async function(e) {
    ...
    try {
      const res = await fetch('https://yours-fashion.onrender.com/api/change-credentials', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`
